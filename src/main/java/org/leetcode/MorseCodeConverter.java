...
public class MorseCodeConverter {
    ...
    private static final Map<Character, Character> CAESARS_CIPHER;
    ...
    public static String getTranslatedValue(String text,TranslationsType type) {
        ...
        if(type.equals(TranslationsType.MORSE)){
            StringBuilder stringBuilder = new StringBuilder();

            for(char c : text.toCharArray()){
                if(ALPHABET_TO_MORSE.containsKey(c)){
                    String value = ALPHABET_TO_MORSE.get(c);
